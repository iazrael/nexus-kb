...
## 定义
Vannevar Bush 于 1945 年提出的个人知识设备概念，允许用户存储所有书籍和记录，在任意条目之间建立永久链接，形成"思维路径"。

## 核心要点
1. **前瞻性设计**：Bush 在 80 年前就设想的关联索引、个人知识库、可分享的知识路径，与现代 LLM Wiki 高度相似
2. **思维路径（Trails）**：用户可以在任意两个条目之间建立永久链接，这些路径可以分享给别人，别人可以在自己的 Memex 里继续扩展
